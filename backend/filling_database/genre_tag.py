...
dag_mapping = {
    ...
    "nautical fiction": {"fiction", "historical fiction", "action & adventure"},
    ...
    "Fiction": {
        ...
        "Speculative Fiction": {
            "Science Fiction": {
                ...
                "Comedy": {"Sci-Fi Comedy / Comic Science Fiction": {}},
                "Fantasy": {
                    "Social & Political Fiction": {
                        "Science Fantasy": {
                            "Libertarian Sci-Fi": {},
            ...
            "Horror": {
                "Comedy": {"Comedy Horror": {"Zombie Comedy": {}}},
                "Body Horror": {},
                "Ghost Stories": {},
                "Japanese Horror": {},
                "Korean Horror": {},
        ...
        "Historical Fiction": {
            "Crime & Mystery": {"Mystery": {"Historical Mystery": {}}},
            "Alternate History": {},
            "Nautical Fiction": {"Pirate Novel": {}},
        },
        ...
        "Romance": {
            ...
            "Amish Romance": {},
            "Chivalric Romance": {},
            "Contemporary Romance": {"Gay Romance": {}, "Lesbian Romance": {}},
            "Erotic Romance": {},
        ...
        "Satire": {},
        "Social & Political Fiction": {"Political Thriller": {}},
        "Action & Adventure": {
            "Robinsonade Fiction": {},
            "Nautical Fiction": {"Pirate Fiction": {}},
            "Spy Fiction": {"Spy-Fi": {}},
            "Subterranean Fiction": {},
            "Swashbuckler": {"Picaresque": {}},
        },
        "Comedy": {
            "Burleque": {},
            "Parody": {"Metaparody": {}},
...
approved_genre_related = {
    ...
    "space western": {
        ...
        "cosmic cowboy",
        "futuristic frontier",
        "interstellar western",
        "star cowboy",
        "galactic frontier",
        "space adventure western",
        "cosmic western",
        "sci-fi western",
        "space outlaws",
    },
    ...
    "christian science fiction": {
        ...
        "spiritual sci-fi",
        "biblical sci-fi",
        "religious futuristic",
        "inspirational sci-fi",
        "God in the future",
        "divine science fiction",
        "sacred sci-fi",
    ...
    "legal thriller": {
        ...
        "legal crime",
        "attorney thriller",
        "law and order fiction",
    },
    "financial thriller": {
        "financial thriller",
        "money thriller",
        "banking thriller",
        "corporate crime thriller",
        "economics thriller",
        "financial suspense",
        "stock market thriller",
        "investment thriller",
    ...
    "psychological thriller": {
        ...
        "brain-teaser thriller",
        "inner conflict thriller",
        "cerebral thriller",
        "psych drama",
    ...
    "time-travel romance": {
        ...
        "temporal romance",
        "romance across time",
        "time-hopping romance",
        "historic romance with time travel",
        "romantic time travel",
        "time-crossed romance",
        "chronological romance",
        "time-bound love",
        "time-displaced romance",
    },
    "women's fiction": {
        "women's fiction",
        "female fiction",
    ...
    "northwestern": {
        "northwestern",
        "northwestern fiction",
        "midwest fiction",
        "northern fiction",
        "regional western",
        "northwestern literature",
        "regional stories",
        "western region fiction",
        "midwestern tales",
        "northern narratives",
    },
    "folklore": {
    ...
    "Social & Political Fiction, Horror & Suspense": {
        ...
        "social thriller",
        "political terror",
        "socio-political suspense",
        "dark social fiction",
        "political horror",
        "horror with politics",
        "social commentary horror",
        "suspenseful political horror",
    },
    "Political Thriller": {
        "political thriller",
        "political suspense",
    ...
    "Subterranean Fiction": {
        ...
        "underground tale",
        "cave story",
        "below-ground fiction",
        "subsurface adventure",
...
def remove_mixed_fiction_nonfiction(genres, summary, genre, tags):
    ...
    age_range = {"children's", "young adult", "adult", "fratire", "lad lit"}
    ...
    fiction_set = {tag.lower() for tag in (fiction_set)}
    ...
    if unclassified:
        print(
            "Warning: The following genres are unclassified and will be dropped:",
            unclassified,
        )
    ...
    if fiction_genres and not nonfiction_genres:
        ...
        if ("fiction" in tags_lower or "fiction" in genre_lower) and (
            "nonfiction" not in tags_lower
            and "nonfiction" not in genre_lower
            and "non-fiction" not in tags_lower
            and "non-fiction" not in genre_lower
        ):
            chosen_branch = fiction_genres
        ...
        elif ("nonfiction" in tags_lower or "nonfiction" in genre_lower) and (
            "fiction" not in tags_lower and "fiction" not in genre_lower
        ):
            chosen_branch = nonfiction_genres
...
def process_books():
    ...
    books = list(
        books_collection.find(
            {"$or": [{"genre_tags": {"$exists": False}}, {"genre_tags": {"$size": 0}}]}
        )
    )
    ...
    for book in books:
        ...
        tags = book.get("tags", [])
        current_tags = (
            {tag.lower() for tag in book.get("genre_tags", [])}
            if book.get("genre_tags")
            else set()
        )
        ...
        if matched_genres:
            ...
            extended_genres = remove_mixed_fiction_nonfiction(
                extended_genres, summary, genre, tags
            )
            new_tags = list(current_tags | extended_genres)

            if new_tags:
                books_collection.update_one(
                    {"_id": book["_id"]}, {"$set": {"genre_tags": new_tags}}
                )
